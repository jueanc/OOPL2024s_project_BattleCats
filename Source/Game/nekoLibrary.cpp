...
namespace game_framework {
	...
	{
		if (name == "Cat") {				//¿ß«}¸ê®Æ
			char *temp[17] = { "./Resources/cats/cat/Move0.bmp","./Resources/cats/cat/cat1.bmp","./Resources/cats/cat2.bmp","./Resources/cats/cat/cat3.bmp","./Resources/cats/cat/§ðÀ»0.bmp","./Resources/cats/cat/§ðÀ»1.bmp","./Resources/cats/cat/§ðÀ»3.bmp","./Resources/cats/cat/§ðÀ»4.bmp","./Resources/cats/cat/§ðÀ»5.bmp","./Resources/cats/cat/À»°h0.bmp","./Resources/cats/cat/À»°h1.bmp","./Resources/cats/cat/À»°h2.bmp","./Resources/cats/cat/À»°h3.bmp","./Resources/cats/cat/À»°h4.bmp","./Resources/cats/cat/À»°h5.bmp","./Resources/cats/cat/À»°h6.bmp","./Resources/cats/cat/À»°h7.bmp" };
			...
			char *temp[1] = { "./bitmaps/¶ð/tower.bmp" };
			return temp[imageNumber];
		}
		else {
			char *temp[1] = {"./Resources/cats/cat/¿ß«}0.bmp"};
			return temp[imageNumber];
		}
	}
